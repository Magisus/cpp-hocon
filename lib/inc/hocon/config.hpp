...
namespace hocon {
     ...
     */
    class config : public config_mergeable {
    public:
        /**
         ...
         */
        virtual shared_config resolve() const = 0;
         ...
         */
        virtual shared_config resolve(config_resolve_options options) const = 0;
         ...
         * @return an immutable object with substitutions resolved
         */
        virtual shared_config resolve_with(shared_config source) const = 0;
         ...
         */
        virtual shared_config resolve_with(shared_config source, config_resolve_options options) const = 0;
         ...
         */
        virtual void check_valid(shared_config reference, std::vector<std::string> restrict_to_paths) const = 0;
         ...
         */
        virtual bool has_path(std::string path) const = 0;
         ...
         */
        virtual bool has_path_or_null(std::string path) const = 0;
         ...
         */
        virtual shared_config with_only_path(std::string path) const = 0;
         ...
         */
        virtual shared_config without_path(std::string path) const = 0;
         ...
         *         path.
         */
        virtual shared_config at_path(std::string path) const = 0;
         ...
         *         key.
         */
        virtual shared_config at_key(std::string key) const = 0;
